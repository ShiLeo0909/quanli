...
import QuanLiSinhVien.DanhSachSinhVien;
...
//				1.	Thêm sinh viên vào danh sách.
                ...
                DanhSachSinhVien.SinhVien sv = new DanhSachSinhVien.SinhVien(maSinhVien, hoVaTen, namSinh, diemTrungBinh);
...
//				6.	Kiểm tra sinh viên có tồn tại trong danh sách hay không, dựa trên mã sinh viên.
                System.out.println("Nhập mã sinh viên: "); String maSinhVien = sc.nextLine();
                DanhSachSinhVien.SinhVien sv = new DanhSachSinhVien.SinhVien(maSinhVien);
