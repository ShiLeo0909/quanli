...
public class StudentManager {
    ...
    public List<Student> filterStudentsHighestAverageGrade(int howMany) {
        ...
        List<Student> filteredStudents = sortedStudents.subList(0, Math.min(howMany, sortedStudents.size()));
        return filteredStudents;
    }
    ...
    public List<Student> filterStudentsByIncreasingAverageGrade() {
        List<Student> sortedStudents = new ArrayList<>(studentList);
        Collections.sort(sortedStudents, Comparator.comparingDouble(Student::getAverageGrade));
        return sortedStudents;
    }
    public List<Student> filterStudentsByDecreasingAverageGrade() {
        List<Student> sortedStudents = new ArrayList<>(studentList);
        Collections.sort(sortedStudents, Comparator.comparingDouble(Student::getAverageGrade).reversed());
        return sortedStudents;
    }
